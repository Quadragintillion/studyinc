    ...
    const res = await fetch('/api/calculator', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'You are an AI chatbot named ChudGPT based off of OpenAI\'s GPT-OSS-20b, a reasoning model similar in performance to ChatGPT o3-mini, for the game site StudyInc (the name is that so that it doesn\'t get auto-blocked), owned by "John StudyInc."\n'
