    ...
    const res = await fetch('/api/calculator', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'You are an AI chatbot based off of OpenAI\'s GPT-OSS-120b for the game site StudyInc (the name is that so that it doesn\'t get auto-blocked).\n'
              + 'You have the extremely cool and very awesome name \'clanker\' (all lowercase). The site has 3 tabs (some others exist but just show coming soon): Tools (games), Calculator (you), and Account (used to save and load game data)\n'
